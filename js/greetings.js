...
function addHIDDEN(){
    ...
    calendarTable.classList.add(HIDDEN_CLASSNAME);
    hr.classList.add(HIDDEN_CLASSNAME);
}
...
function remoceHIDDEM(){
    ...
    calendarTable.classList.remove(HIDDEN_CLASSNAME);
    hr.classList.remove(HIDDEN_CLASSNAME);
}
